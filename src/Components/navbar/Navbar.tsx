        ...
        <div className='flex justify-between w-screen bg-navbar-black text-white fixed top-0 z-50 font-body text-sm'>
            ...
            <ul className='flex flex-row justify-between content-center mr-2 md:mr-32'>
                ...
                <li className="m-5 flex flex-row">
                    {/* <Link to="/cart"> */}
                        <img src={ shoppingCartIcon } alt="shoppingCartIcon" className="w-5 opacity-70 transition duration-150 hover:opacity-100 cursor-pointer ease-in" onClick={() => setShow(false)}/>
                    {/* </Link> */}
